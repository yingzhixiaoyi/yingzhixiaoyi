<template>
    <div id="layout-footer">
        ...
        <div class="copyright">Copyright © 2020 by
            <a class="out-link" href="http://yingzhixiaoyi.gitee.io/" target="_blank">yingzhixiaoyi</a>
            . All rights reserved. |
            <a class="out-link" href="https://yingzhixiaoyi.github.io/yingzhixiaoyi/" target="_blank">深ICP备20201123号-1
            </a>
        </div>
    </div>
</template>
